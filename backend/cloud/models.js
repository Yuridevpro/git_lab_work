...
// Classe Opcao
Parse.Object.registerSubclass("Opcao", class Opcao extends Parse.Object {
  constructor() {
      super("Opcao");
  }

  getRefeicao() {
      return this.get("refeicao");
  }
  ...
  getTamanhoPorcao() {
      return this.get("tamanhoPorcao");
  }
  setTamanhoPorcao(tamanhoPorcao) {
      this.set("tamanhoPorcao", tamanhoPorcao);
  }

  getInformacoesNutricionais() {
      return this.get("informacoesNutricionais");
  }
  setInformacoesNutricionais(informacoesNutricionais) {
      this.set("informacoesNutricionais", informacoesNutricionais);
  }
});